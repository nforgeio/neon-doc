...
NeonKUBE is a Full Stack Kubernetes Distribution which includes Kubernetes Core,
...
NeonKUBE requires a 4-core computer with at least 16 GiB RAM and about 75 GiB of
...
consuming about 5.5 gig of memory, leaving 2.5 gig for user applications.

NeonKUBE clusters can be suspended at any time to quickly release this memory
when the cluster isn’t needed. This only takes a few seconds.
