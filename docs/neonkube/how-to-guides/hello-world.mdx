...
The `HelloWorldDemo` Custom Resource `spec` allows for configuration of the demo.
...
If set to true, the Operator will configure the `hello-world` demo to use the Cluster built-in Single Sign On. Users will need to have cluster
credentials to access the demo.
