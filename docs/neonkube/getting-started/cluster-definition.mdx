...
<Image img={require("../assets/cluster-deployment/clusterdef-hyperv.png")} style={{ width: 700 }} />
...
<Image img={require("../assets/cluster-deployment/clusterdef-azure.png")} style={{ width: 700 }} />
...
a public version of this tool if there's demand.
:::
