...
```plain
az vm image terms show --urn neonforge:neonkube:0-11-0:0.11.0
```

Accept the terms

```plain
az vm image terms accept --urn neonforge:neonkube:0-11-0:0.11.0
```
...
The **0-11-0:0.11.0** version part of the URN above is formatted with the first
