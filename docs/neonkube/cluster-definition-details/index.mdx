...
slug: /cluster-definition-details
sidebar_position: 8
displayed_sidebar: neonkube
title: Cluster Definition Details
hide_title: false
hide_table_of_contents: false
description: Describes the NeonKUBE cluster definition file format
keywords:
  - introduction
last_update:
...
This documentation section describes the cluster definition format in detail.
Here's the top-level structure of a cluster definition:
