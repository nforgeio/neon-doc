...
ara import Admonition from "@theme/Admonition"; import CodeBlock from
"@theme/CodeBlock"; import Image from "@theme/IdealImage"; import TabItem from
"@theme/TabItem"; import Tabs from "@theme/Tabs";

# Hosting Options

Specifies hosting related settings for the cloud or on-premise provider. This is
required. We're going to organize the documentation below by target hosting
environment.
...
Specifies common hosting settings for on-premise hypervisor environments like
